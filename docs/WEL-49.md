...
- Successful collection uses an assessed surface's cadence (6 hours–30 days); absent/unattributed sources keep 7 days. Errors and blocked-source backoff remain unchanged. A response's Retry-After is a floor measured from receipt. Both delta seconds and HTTP dates work; 60-day deadlines are not capped. Unrepresentable deadlines stall for explicit review.
